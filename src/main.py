...
simulation.create_roaming_agents(10, 'roaming')
simulation.create_roaming_agents(10, 'careful_roaming')
simulation.create_roaming_agents(5, 'aggressive_roaming')
simulation.create_homing_agents(10, 'homing')
simulation.create_homing_agents(10, 'careful_homing')
